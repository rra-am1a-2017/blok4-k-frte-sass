        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-50 h-50 mx-auto" src="./images/kwikkwekkwak.png" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-50 h-50 mx-auto" src="./images/dagobertduck.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
